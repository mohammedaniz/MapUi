...
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    ...
    marker.bindPopup("<ul class='list-group'><li class='list-group-item'>First item</li><li class='list-group-item'>Second item</li><li class='list-group-item'>Third item</li></ul>").openPopup();
